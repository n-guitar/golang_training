...
// 参考：https://golang.org/pkg/encoding/json/#NewDecoder
// NewDecoderは、rから読み込む新しいデコーダを返す
func NewDecoder(r io.Reader) *Decoder {
	return &Decoder{r}
}

// エンコードされた値を入力から読み込み、それをvが指す値に格納
func (dec *Decoder) Decode(v interface{}) (err error) {
	lex := &lexer{scan: scanner.Scanner{Mode: scanner.GoTokens}}
	lex.scan.Init(dec.reader) // decodeに合わせて変更
	...
	read(lex, reflect.ValueOf(v).Elem()) // decodeに合わせて変更
	return nil
}
